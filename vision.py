...
_EXTRACT_PROMPT = (
    ...
    'Formatting rules — these are critical for downstream translation:\n'
    '- Preserve line breaks: every visual line in the image is a separate '
    'line in your output. Do NOT merge lines into paragraphs.\n'
    '- Preserve bullets, dashes, and list markers (•, -, ·, *, ○, ◦) '
    'exactly as they appear, on their own at the start of the line.\n'
    '- Preserve numbered lists ("1.", "2.", "أ-", "ب-", etc.) exactly.\n'
    '- Preserve blank lines between paragraphs / bullets / sections.\n'
    '- Preserve indentation when it conveys hierarchy (sub-bullets).\n'
    '- Keep ALL CAPS as ALL CAPS; keep punctuation as written.\n'
    '- For right-to-left scripts (Arabic, Hebrew, Persian, Urdu), output '
    'the logical reading order — same character sequence the user sees '
    'top-to-bottom, right-to-left within each line.\n\n'
